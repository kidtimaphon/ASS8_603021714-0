...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 06, 2019 at 08:36 PM
...
(33, 'Kidtimaphon', 'Female', 'kidtimaphon_a@kkumail.com', 75000);
...
--
ALTER TABLE `employee`
  MODIFY `emp_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
COMMIT;
